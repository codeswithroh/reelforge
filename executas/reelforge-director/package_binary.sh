...
ENTRY_FILE="reelforge_director.py"
OUT_DIR="dist-anna"
...
case "$OS-$ARCH" in
    ...
    *)
        ...
        echo "This script targets: darwin-arm64, darwin-x86_64, linux-x86_64" >&2
        exit 1
        ;;
esac
...
{
    "$PLATFORM": {
        "url": "https://github.com/codeswithroh/reelforge/releases/download/reelforge-v$VERSION/$TOOL_ID-$PLATFORM.tar.gz",
        "sha256": "$SHA256",
        "size": $SIZE,
